...
const CourseList = () => {
  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in h-full pt-2">
      ...
      <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 mt-2 mb-6">
        {!loading && filtered.length > 0 ? (
          filtered.map(course => (
            ...
            >
              <div className="relative w-28 sm:w-36 md:w-full md:h-48 overflow-hidden shrink-0">
