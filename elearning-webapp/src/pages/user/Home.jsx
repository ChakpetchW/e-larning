...
const Home = () => {
  ...
  return (
    <div className="flex flex-col gap-8 md:gap-10 animate-fade-in pt-0 md:pt-4 pb-12">
      ...
      <section className="relative -mx-5 md:mx-0 rounded-none md:rounded-[3rem] md:rounded-t-[3rem] overflow-hidden mesh-bg-premium p-6 md:p-12 lg:p-16 mb-2 border-b md:border border-white/60 shadow-2xl shadow-slate-200/50 group">
