...
2. **Analyze the current feature**: Assess what works and what doesn't:
   ...
   - What's the root causeโ€”missing tokens, one-off implementations, or conceptual misalignment?
...
This is not an exhaustive listโ€”apply judgment to identify all areas needing normalization.
